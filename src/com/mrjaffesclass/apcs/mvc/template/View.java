...
public class View extends JFrame implements MessageHandler {
    ...
    private int lives = 3;
    private int score = 0;
    private int sexyness = 1;
    private JLabel lifeLabel = new JLabel(lives + "");
    private JLabel scoreLabel = new JLabel(score + "");
    private JLabel sexynessLabel = new JLabel(sexyness + "");
    ...
    public View(Messenger messenger) {
        ...
        panel2.add(new Label("Sexyness counter:"));
        panel2.add(sexynessLabel);
    ...
    public void init() {
        ...
        messenger.subscribe("Model:EarnSexy", this);
    ...
    private void earnSexy() {
        sexyness++;
        sexynessLabel.setText(sexyness + "");
        if (sexyness >= 1000) {
        messenger.notify("View:SendSexyness", sexyness);
            messenger.notify("View:EndGame", true);
        }
    }
